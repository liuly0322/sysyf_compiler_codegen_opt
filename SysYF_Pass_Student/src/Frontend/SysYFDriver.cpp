...
SysYFDriver::SysYFDriver() : trace_scanning(false), trace_parsing(false) {}
...
void SysYFDriver::error(const std::string &m) { std::cerr << m << std::endl; }
...
void SysYFDriver::scan_end() { instream.close(); }
