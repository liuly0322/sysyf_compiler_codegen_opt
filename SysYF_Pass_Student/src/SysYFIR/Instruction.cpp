...
BinaryInst *BinaryInst::create_sdiv(Value *v1, Value *v2, BasicBlock *bb,
                                    Module *m) {
    return new BinaryInst(Type::get_int32_type(m), Instruction::sdiv, v1, v2,
                          bb);
}

BinaryInst *BinaryInst::create_srem(Value *v1, Value *v2, BasicBlock *bb,
                                    Module *m) {
    return new BinaryInst(Type::get_int32_type(m), Instruction::srem, v1, v2,
                          bb);
}

BinaryInst *BinaryInst::create_fadd(Value *v1, Value *v2, BasicBlock *bb,
                                    Module *m) {
    return new BinaryInst(Type::get_float_type(m), Instruction::fadd, v1, v2,
                          bb);
}

BinaryInst *BinaryInst::create_fsub(Value *v1, Value *v2, BasicBlock *bb,
                                    Module *m) {
    return new BinaryInst(Type::get_float_type(m), Instruction::fsub, v1, v2,
                          bb);
}

BinaryInst *BinaryInst::create_fmul(Value *v1, Value *v2, BasicBlock *bb,
                                    Module *m) {
    return new BinaryInst(Type::get_float_type(m), Instruction::fmul, v1, v2,
                          bb);
}

BinaryInst *BinaryInst::create_fdiv(Value *v1, Value *v2, BasicBlock *bb,
                                    Module *m) {
    return new BinaryInst(Type::get_float_type(m), Instruction::fdiv, v1, v2,
                          bb);
}
...
BranchInst::BranchInst(Value *cond, BasicBlock *bb)
    : Instruction(Type::get_void_type(bb->get_module()), Instruction::br, 3,
                  bb) {
    set_operand(0, cond);
}
...
BranchInst::BranchInst(BasicBlock *bb)
    : Instruction(Type::get_void_type(bb->get_module()), Instruction::br, 1,
                  bb) {}
...
GetElementPtrInst::GetElementPtrInst(Value *ptr, std::vector<Value *> idxs,
    ...
    : Instruction(PointerType::get(get_element_type(ptr, idxs)),
                  Instruction::getelementptr, 1 + idxs.size(), bb) {
    set_operand(0, ptr);
